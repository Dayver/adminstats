...
$L['adminstats_cot_defaulttheme'] = 'Тема оформления, по умолчанию';
$L['adminstats_cot_defaultscheme'] = 'Цветовая схема, по умолчанию';
$L['adminstats_cot_defaulticons'] = 'Пакет значков, по умолчанию';
$L['adminstats_cot_defaultlang'] = 'Язык, по умолчанию';
$L['adminstats_cot_admintheme'] = 'Тема оформления панели администрирования';
...
$L['adminstats_cot_html_cleanup'] = 'Удаление пробелов и переносов в HTML';
$L['adminstats_cot_cache_index'] = 'Статическая кэш для гостей главной';
$L['adminstats_cot_cache_page'] = 'Статическая кэш для гостей страниц и категорий';
$L['adminstats_cot_cache_forums'] = 'Статическая кэш для гостей на форумах';
$L['adminstats_cot_check_updates'] = 'Автоматически проверять наличие обновлений';
...
$L['adminstats_cot_useremailduplicate'] = 'Регистрация новых учетные записи с дублирующимся Email';
